...
const NewsCard: React.FC<{ item: NewsItem }> = ({ item }) => (
  ...
  >
    <h3 className="font-semibold text-[1.05rem] leading-snug mb-1 text-[#0b1e3c] dark:text-white focus:underline hover:underline outline-none">
      {item.headline}
    </h3>
    <p className="text-gray-800 dark:text-gray-200 text-base line-clamp-3 mb-2" style={{ lineHeight: 1.55 }}>
      {item.summary}
    </p>
