  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="py-12 bg-white dark:bg-gray-950 md:max-w-7xl mx-auto">
        <div className="container mx-auto px-4">
          <h2 id="popular" className="text-2xl font-bold text-gray-900 dark:text-white mb-8">{t('ai.popular')}</h2>
      ...
      <section className="py-12 bg-gray-50 dark:bg-gray-900 md:max-w-7xl mx-auto">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            <motion.div className="relative bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-8" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">{t('ai.tools.trading_assistant.title')}</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-5">{t('ai.tools.trading_assistant.description')}</p>
              <Button asChild>
                <Link href="/ai-tools/trading-assistant">{t('ai.try_assistant')} <ChevronRight className="ml-2 h-4 w-4" /></Link>
              </Button>
            </motion.div>

            <motion.div className="relative bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-xl p-8" initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
              <span className="absolute top-4 right-4 z-20 px-3 py-1 rounded-full bg-yellow-400 text-yellow-900 text-xs font-bold shadow-md dark:bg-yellow-300 dark:text-yellow-900" aria-label={t('ai.coming_soon')}>{t('ai.coming_soon')}</span>
              <div className="bg-white dark:bg-gray-800 p-3 rounded-full w-fit mb-4">
                <Bot className="h-6 w-6 text-amber-600 dark:text-amber-500" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">{t('ai.tools.trading_bots.title')}</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-5">{t('ai.tools.trading_bots.description')}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            <Card className="relative">
              <CardContent className="p-6">
                ...
                <div className="flex items-center mb-4">
                  <div className="bg-blue-50 dark:bg-blue-900/30 p-2 rounded-full"><Bot className="h-5 w-5 text-blue-600 dark:text-blue-500" /></div>
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">{t('ai.products.semi_auto_ea.title')}</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-5">{t('ai.products.semi_auto_ea.description')}</p>
            ...
            <Card className="relative">
              <CardContent className="p-6">
                <span className="absolute top-4 right-4 z-20 px-3 py-1 rounded-full bg-yellow-400 text-yellow-900 text-xs font-bold shadow-md dark:bg-yellow-300 dark:text-yellow-900" aria-label={t('ai.coming_soon')}>{t('ai.coming_soon')}</span>
                <div className="flex items-center mb-4">
                  <div className="bg-amber-50 dark:bg-amber-900/20 p-2 rounded-full"><Bot className="h-5 w-5 text-amber-600 dark:text-amber-500" /></div>
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">{t('ai.products.full_auto_ea.title')}</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-5">{t('ai.products.full_auto_ea.description')}</p>
                <Button variant="secondary" disabled className="cursor-not-allowed">{t('ai.available_soon')}</Button>
              </CardContent>
            </Card>
            ...
            <Card className="relative">
              <CardContent className="p-6">
                <span className="absolute top-4 right-4 z-20 px-3 py-1 rounded-full bg-yellow-400 text-yellow-900 text-xs font-bold shadow-md dark:bg-yellow-300 dark:text-yellow-900" aria-label={t('ai.coming_soon')}>{t('ai.coming_soon')}</span>
                <div className="flex items-center mb-4">
                  <div className="bg-indigo-50 dark:bg-indigo-900/20 p-2 rounded-full"><LineChart className="h-5 w-5 text-indigo-600 dark:text-indigo-500" /></div>
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-1">{t('ai.products.proven_strategies_semi.title')}</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-5">{t('ai.products.proven_strategies_semi.description')}</p>
            ...
            <Card className="relative">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-1">{t('ai.products.proven_strategies_full.title')}</h3>
                <p className="text-gray-600 dark:text-gray-300 mb-5">{t('ai.products.proven_strategies_full.description')}</p>
                <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-300 mb-5 space-y-1">
          ...
          {filteredTools.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-600 dark:text-gray-400">{t('ai.no_results')}</p>
