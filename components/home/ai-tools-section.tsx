    ...
    <section className="py-16 bg-gray-50 w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900">AI Trading Tools</h2>
          <p className="mt-3 text-lg text-gray-600 max-w-2xl mx-auto">
            Enhance your trading with our cutting-edge AI-powered tools and analytics.
          </p>
          <Link href="/ai-tools" className="mt-4 inline-flex items-center text-blue-600 font-medium hover:text-blue-800 mx-auto">
                ...
                <Card className="h-full w-full flex flex-col transition-all duration-300 hover:shadow-lg hover:-translate-y-1 overflow-hidden group">
                  <CardContent className="p-6 flex flex-col h-full w-full">
                    <div className="flex items-center mb-4">
                      ...
                      <div className="ml-auto flex items-center text-sm text-gray-500 whitespace-nowrap">
                    ...
                    <div className="mt-auto pt-2 text-blue-600 font-medium flex items-center group-hover:translate-x-1 transition-transform duration-200">
                      Try now 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">AI Trading Assistant</h3>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">Automated Trading Bots</h3>
            <p className="text-gray-600 mb-5">
