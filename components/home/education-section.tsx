    ...
    <section className="py-16 bg-white dark:bg-gray-950">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Forex Education Center</h2>
          ...
          <Link href="/education" className="mt-4 md:mt-0 inline-flex items-center text-blue-600 dark:text-blue-500 font-medium hover:text-blue-800 dark:hover:text-blue-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Forex Trading Courses</h3>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Weekly Market Analysis</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-5">
