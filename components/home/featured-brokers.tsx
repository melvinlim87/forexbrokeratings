                  ...
                  <div className="flex-1 flex flex-col space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        <motion.div className="relative flex items-center bg-gradient-to-br from-amber-100/80 to-amber-50/80 dark:from-amber-900/30 dark:to-amber-800/20 backdrop-blur-sm rounded-xl px-3 py-2 mr-3 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.1)] dark:shadow-[0_2px_10px_-3px_rgba(255,255,255,0.1)]">
                          <div className="flex space-x-0.5">
                            {[...Array(5)].map((_, i) => {
                              ...
                              const delay = hoveredCard === broker.rank ? i * 0.15 : 0;
