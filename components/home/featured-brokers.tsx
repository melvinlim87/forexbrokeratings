            ...
            >
              <Card 
                className={cn(
                  ...
                  "before:bg-gradient-to-br before:from-gray-400 before:via-gray-200 before:to-gray-500",
                  ...
                  "after:bg-gradient-to-br after:from-black/30 after:via-black/20 after:to-transparent",
